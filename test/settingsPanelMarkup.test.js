...
test('settings panel rows declare scopes for widget-specific context menus', () => {
  ...
  assert.ok(html.includes('id="settings-mode-summary"'))
  assert.ok(html.includes('id="settings-back-global"'))
  assert.ok(html.includes('id="pet-chat-enabled"'))
  assert.ok(html.includes('id="pet-chat-interval"'))
  assert.ok(html.includes('id="pet-chat-quiet"'))
  assert.ok(html.includes('id="pet-chat-tone"'))
  assert.ok(html.includes('id="activity-filter"'))
  assert.ok(html.includes('id="activity-range"'))
  assert.ok(html.includes('id="activity-log-export"'))
  assert.ok(html.includes('id="activity-log-clear"'))
})
